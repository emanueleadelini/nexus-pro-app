...
2. [Specifiche Data Model](./docs/DATA-MODEL-SPEC.md) - Struttura Firestore.
3. [Logica Security Rules](./docs/SECURITY-RULES-LOGIC.md) - Permessi e Multi-tenancy.
4. [Ingegneria AI](./docs/AI-ENGINEERING.md) - Genkit e Prompt Strategy.
