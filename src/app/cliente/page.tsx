      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Flusso Approva & Pubblica 2.0</p>
          </div>
        </div>
        <Dialog>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="space-y-6">
              ...
              <div className="divide-y divide-gray-100">
                {['piano_strategico', 'piano_comunicazione', 'business_plan', 'business_model'].map(id => (
                  <div key={id} className="p-4 flex items-center justify-between hover:bg-gray-50">
                    ...
                    {strategicDocs.find(d => d.tipo_strategico === id) && <Download className="w-4 h-4 text-indigo-600 cursor-pointer" />}
                  </div>
                ))}
              </div>
            </CardContent>
          ...
          <Card className="p-4 rounded-xl border-gray-200">
            <Calendar mode="single" selected={selectedDate} onSelect={setSelectedDate} modifiers={{ hasPost: (d) => daysWithPosts.includes(d.toDateString()) }} modifiersClassNames={{ hasPost: "bg-indigo-100 text-indigo-900 font-bold" }} />
          </Card>
        </div>

        <div className="lg:col-span-2 space-y-6">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-headline font-bold">Preview Instagram</h2>
                    ...
                    <div className="aspect-square bg-gray-50 relative group">
                      {material?.url_storage ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-gray-300">
                          ...
                          <span className="text-[10px] uppercase font-bold">Asset in Elaborazione</span>
                        </div>
                      )}
                    </div>
