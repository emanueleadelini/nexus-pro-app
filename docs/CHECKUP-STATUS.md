# Nexus Pro - Checklist Lancio 100% Online (v10.3)
...
| **Source Control** | 100% | Repository GitHub collegato e sincronizzato. |
...
1. **Firebase Storage**: Attualmente gestiamo i metadati degli asset. È necessario abilitare il bucket Storage per il caricamento fisico di file reali.
2. **Cloud Functions**: Implementare un trigger server-side per il "Silenzio Assenso" che approvi automaticamente i post dopo 24h.
